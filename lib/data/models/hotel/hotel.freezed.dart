...
class _$_Hotel implements _Hotel {
  ...
  @override
  String toString() {
    return 'Hotel(id: $id, name: $name, adress: $adress, priceForIt: $priceForIt, minimalPrice: $minimalPrice, rating: $rating, ratingName: $ratingName, imageUrls: $imageUrls, description: $description, peculiarities: $peculiarities)';
  }
